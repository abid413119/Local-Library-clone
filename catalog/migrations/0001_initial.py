# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-29 13:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('02fe64c4-d7c6-453f-8505-3e19b263ea68'), help_text='Unique ID for this particular book across whole library', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. SciFi, Poetry, History)', max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
